 ...
 */
class BuyerConsentResponseBuyer extends SpecObject implements BuyerConsentResponseBuyerInterface
{
    /**
     * @return string|null
     */
     ...
     */
    public function getConsent(): BuyerConsentResponseConsentInterface|null
    {
        return $this->instanceOrNull(self::KEY_CONSENT, \Magebit\UcpSpec\Api\Shopping\BuyerConsentResponseConsentInterface::class);
    }
     ...
     * @return self
     */
    public function setConsent(BuyerConsentResponseConsentInterface|null $consent): self
    {
