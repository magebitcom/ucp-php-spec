 ...
 */
class DiscountCreateRequestAppliedDiscount extends SpecObject implements DiscountCreateRequestAppliedDiscountInterface
{
    /**
     * @return string|null
     */
    ...
    {
        return $this->instanceListOrNull(self::KEY_ALLOCATIONS, \Magebit\UcpSpec\Api\Shopping\DiscountCreateRequestAllocationInterface::class);
    }

    /**
     * @param \Magebit\UcpSpec\Api\Shopping\DiscountCreateRequestAllocationInterface[]|null $allocations
     * @return self
     */
