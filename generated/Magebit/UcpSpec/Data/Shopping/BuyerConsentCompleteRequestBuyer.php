...
use Magebit\UcpSpec\Api\Shopping\BuyerConsentCompleteRequestBuyerInterface;
use Magebit\UcpSpec\Api\Shopping\BuyerConsentCompleteRequestConsentInterface;
use Magebit\UcpSpec\Runtime\SpecObject;

/**
 * Buyer object extended with consent tracking.
 */
class BuyerConsentCompleteRequestBuyer extends SpecObject implements BuyerConsentCompleteRequestBuyerInterface
{
    /**
     * @return string|null
     */
    ...
    {
        return $this->instanceOrNull(self::KEY_CONSENT, \Magebit\UcpSpec\Api\Shopping\BuyerConsentCompleteRequestConsentInterface::class);
    }
