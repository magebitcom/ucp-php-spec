...
use Magebit\UcpSpec\Api\Shopping\Types\RetailLocationRequestInterface;
use Magebit\UcpSpec\Runtime\SpecObject;

/**
 * A pickup location (retail store, locker, etc.).
 */
class RetailLocationRequest extends SpecObject implements RetailLocationRequestInterface
{
    /**
     * @return string
     */
