...
use Magebit\UcpSpec\Api\Shopping\Types\FulfillmentGroupUpdateRequestInterface;
use Magebit\UcpSpec\Api\Shopping\Types\FulfillmentMethodUpdateRequestInterface;
...
class FulfillmentMethodUpdateRequest extends SpecObject implements FulfillmentMethodUpdateRequestInterface
{
    ...
    {
        return $this->instanceListOrNull(self::KEY_GROUPS, \Magebit\UcpSpec\Api\Shopping\Types\FulfillmentGroupUpdateRequestInterface::class);
    }
