...
use Magebit\UcpSpec\Api\Shopping\BuyerConsentUpdateRequestConsentInterface;
use Magebit\UcpSpec\Runtime\SpecObject;

/**
 * Buyer object extended with consent tracking.
 */
class BuyerConsentUpdateRequestBuyer extends SpecObject implements BuyerConsentUpdateRequestBuyerInterface
{
    /**
     * @return string|null
     */
    ...
    /**
     * @return \Magebit\UcpSpec\Api\Shopping\BuyerConsentUpdateRequestConsentInterface|null
     */
    public function getConsent(): BuyerConsentUpdateRequestConsentInterface|null
    {
        return $this->instanceOrNull(self::KEY_CONSENT, \Magebit\UcpSpec\Api\Shopping\BuyerConsentUpdateRequestConsentInterface::class);
    }

    /**
     * @param \Magebit\UcpSpec\Api\Shopping\BuyerConsentUpdateRequestConsentInterface|null $consent
     * @return self
     */
    public function setConsent(BuyerConsentUpdateRequestConsentInterface|null $consent): self
    {
