 ...
 */
class FulfillmentResponseCheckout extends SpecObject implements FulfillmentResponseCheckoutInterface
{
    /**
    ...
    /**
     * @return \Magebit\UcpSpec\Api\Shopping\Types\FulfillmentResponseInterface|null
     */
    public function getFulfillment(): FulfillmentResponseInterface|null
    {
        return $this->instanceOrNull(self::KEY_FULFILLMENT, \Magebit\UcpSpec\Api\Shopping\Types\FulfillmentResponseInterface::class);
    }

    /**
     * @param \Magebit\UcpSpec\Api\Shopping\Types\FulfillmentResponseInterface|null $fulfillment
     * @return self
     */
    public function setFulfillment(FulfillmentResponseInterface|null $fulfillment): self
    {
