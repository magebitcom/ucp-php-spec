...
use Magebit\UcpSpec\Api\Shopping\DiscountResponseAllocationInterface;
 ...
 */
class DiscountResponseAppliedDiscount extends SpecObject implements DiscountResponseAppliedDiscountInterface
{
    /**
     * @return string|null
     */
    ...
    {
        return $this->instanceListOrNull(self::KEY_ALLOCATIONS, \Magebit\UcpSpec\Api\Shopping\DiscountResponseAllocationInterface::class);
    }
