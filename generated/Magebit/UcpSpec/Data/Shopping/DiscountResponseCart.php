...
use Magebit\UcpSpec\Api\Shopping\DiscountResponseCartInterface;
 ...
 */
class DiscountResponseCart extends SpecObject implements DiscountResponseCartInterface
{
    /**
    ...
    {
        return $this->instanceOrNull(self::KEY_DISCOUNTS, \Magebit\UcpSpec\Api\Shopping\DiscountResponseDiscountsObjectInterface::class);
    }
