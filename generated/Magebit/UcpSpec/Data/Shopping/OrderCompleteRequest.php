...
use Magebit\UcpSpec\Api\Shopping\OrderCompleteRequestFulfillmentInterface;
use Magebit\UcpSpec\Api\Shopping\OrderCompleteRequestInterface;
 ...
 */
class OrderCompleteRequest extends SpecObject implements OrderCompleteRequestInterface
{
    /**
    ...
    {
        return $this->requireInstance(self::KEY_FULFILLMENT, \Magebit\UcpSpec\Api\Shopping\OrderCompleteRequestFulfillmentInterface::class);
    }
     ...
     */
    public function getTotals(): TotalsCompleteRequestInterface
    {
        return $this->requireInstance(self::KEY_TOTALS, \Magebit\UcpSpec\Api\Shopping\Types\TotalsCompleteRequestInterface::class);
    }
     ...
     * @return self
     */
    public function setTotals(TotalsCompleteRequestInterface $totals): self
    {
