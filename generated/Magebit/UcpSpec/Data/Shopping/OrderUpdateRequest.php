...
use Magebit\UcpSpec\Api\Shopping\Types\TotalsUpdateRequestInterface;
 ...
 */
class OrderUpdateRequest extends SpecObject implements OrderUpdateRequestInterface
{
    /**
    ...
    /**
     * @return \Magebit\UcpSpec\Api\Shopping\OrderUpdateRequestFulfillmentInterface
     */
    public function getFulfillment(): OrderUpdateRequestFulfillmentInterface
    {
        return $this->requireInstance(self::KEY_FULFILLMENT, \Magebit\UcpSpec\Api\Shopping\OrderUpdateRequestFulfillmentInterface::class);
    }

    /**
     * @param \Magebit\UcpSpec\Api\Shopping\OrderUpdateRequestFulfillmentInterface $fulfillment
     * @return self
     */
    public function setFulfillment(OrderUpdateRequestFulfillmentInterface $fulfillment): self
    {
    ...
    /**
     * @return \Magebit\UcpSpec\Api\Shopping\Types\TotalUpdateRequestInterface[]
     */
    public function getTotals(): TotalsUpdateRequestInterface
    {
        return $this->requireInstance(self::KEY_TOTALS, \Magebit\UcpSpec\Api\Shopping\Types\TotalsUpdateRequestInterface::class);
    }

    /**
     * @param \Magebit\UcpSpec\Api\Shopping\Types\TotalUpdateRequestInterface[] $totals
     * @return self
     */
    public function setTotals(TotalsUpdateRequestInterface $totals): self
    {
