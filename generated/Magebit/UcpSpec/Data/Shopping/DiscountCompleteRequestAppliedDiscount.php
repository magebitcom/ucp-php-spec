...
use Magebit\UcpSpec\Api\Shopping\DiscountCompleteRequestAllocationInterface;
 ...
 */
class DiscountCompleteRequestAppliedDiscount extends SpecObject implements DiscountCompleteRequestAppliedDiscountInterface
{
    /**
     * @return string|null
     */
    ...
    /**
     * @return \Magebit\UcpSpec\Api\Shopping\DiscountCompleteRequestAllocationInterface[]|null
     */
    public function getAllocations(): array|null
    {
        return $this->instanceListOrNull(self::KEY_ALLOCATIONS, \Magebit\UcpSpec\Api\Shopping\DiscountCompleteRequestAllocationInterface::class);
    }

    /**
     * @param \Magebit\UcpSpec\Api\Shopping\DiscountCompleteRequestAllocationInterface[]|null $allocations
     * @return self
     */
